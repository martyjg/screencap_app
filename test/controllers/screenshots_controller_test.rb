...
class ScreenshotsControllerTest < ActionController::TestCase
  ...
  test "should create screenshot" do
    assert_difference('Screenshot.count') do
      post :create, screenshot: { category: @screenshot.category, image: @screenshot.image, movie: @screenshot.movie, user_id: @screenshot.user_id }
    end
  ...
  test "should update screenshot" do
    patch :update, id: @screenshot, screenshot: { category: @screenshot.category, image: @screenshot.image, movie: @screenshot.movie, user_id: @screenshot.user_id }
    assert_redirected_to screenshot_path(assigns(:screenshot))
  end
